...
public class DeliveryTransactionHandler extends Handler implements HttpHandler {
	@Override
	public void handle(HttpExchange exchange) throws IOException {
		if(exchange.getRequestMethod().toUpperCase().equals(Handler.POST))
		{
	        ...
	        {
	            String startPosition = (String)parameters.get("startposition");
	        	String endPosition = (String)parameters.get("endposition");
	        	double hydrogen = Double.parseDouble((String)parameters.get("hydrogen"));
	        	
	        	Transaction tx = new TransactionDelivery(startPosition, endPosition, hydrogen);
