...
public class OrderTransactionHandler extends Handler implements HttpHandler {
	@Override
	public void handle(HttpExchange exchange) throws IOException {
		if(exchange.getRequestMethod().toUpperCase().equals(Handler.POST))
		{
	        ...
	        if(!parameters.isEmpty())
	        {
	        	...
	        	short type = (short)Integer.parseInt((String)parameters.get("type"),16);
	        	long maxtime = Long.parseLong((String)parameters.get("maxtime"));
	        	
	        	Transaction tx = new OrderTransaction(address, type, maxtime);
